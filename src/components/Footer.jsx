...
function Footer(){
    return (
        <div className="footer">
          ...
          <h3 className="download-app">Download the app</h3>

          <img className="apple-button" 
          ...
          <img class="google-play-logo" src="./googlePlayLogo.jpg"></img>


          <p className="copyright">© Nidda 2014-2020</p>

          <div className="footer-list1">
          <p className="footer-list-title">Let's do this together</p>
          <p id="item1-1">For couriers</p>
          <p id="item1-2">For restaurants</p>
          <p id="item1-3">For stores</p>
          <p id="item1-4">For companies</p>
          <p id="item1-5">Jobs</p>
          </div>

        <div className="footer-list2">
          <p className="footer-list-title">Nidda Links</p>
          <p id="item2-1">Contact</p>
          <p id="item2-2">Media</p>
          <p id="item2-3">Support</p>
          <p id="item2-4">Blog</p>
          <p id="item2-5">Responsibility</p>
          <p id="item2-6">Security</p>
          <p id="item2-7">About us</p>
          </div>

        <div className="footer-end">
            <p id="footer-end-p1">Accessibility statement</p>
            <p id="footer-end-p2">Terms and Conditions</p>
            <div className="icons"> 
            <img className="fb icon icon-box" src="https://www.flaticon.com/svg/static/icons/svg/1384/1384005.svg" alt="fb icon"></img>

            <img className="insta icon icon-box" src="https://www.flaticon.com/svg/static/icons/svg/1384/1384031.svg" alt="insta icon"></img>
           
            <img className="linkedin icon icon-box" src="https://www.flaticon.com/svg/static/icons/svg/2111/2111532.svg" alt="linkedin icon"></img>
            
            <img className="twitter icon icon-box" src="https://www.flaticon.com/svg/static/icons/svg/733/733635.svg" alt="twitter icon"></img>
            </div>
        </div>
